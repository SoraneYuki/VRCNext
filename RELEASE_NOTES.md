...
* Removed the **Classic** modal design from World, User, Group, and Avatar modals.
...
* All detail modals (Profile, World, Group, Avatar) now always use the **Compact** layout. The Classic layout has been removed.
* Modal actions and breadcrumb history now always sit in the bar at the top of the modal. The taskbar navigation mode has been removed.
* The Settings > Navigation tab and the matching setup steps were removed.
