...
* Fixed an issue when using the Breadcrumb navbar it would jump between tabs sometimes.
* Fixed an bug when too many items where present in profile modal that content got overflown.
