...
function vroToastSendConfig() {
    const cfg = {
        ...
        left:        !!document.getElementById('vroToastLeft')?.checked,
        ttsLeft:     !!document.getElementById('vroToastLeftTts')?.checked,
        reqInvite:   !!document.getElementById('vroToastReqInvite')?.checked,
        ttsReqInvite: !!document.getElementById('vroToastReqInviteTts')?.checked,
...
function vroLoadSettings(s) {
    ...
    const toastValues = {
        ...
        vroToastLeft: s.vroToastLeft ?? true,
        vroToastReqInvite: s.vroToastReqInvite ?? true,
        vroToastJoinedTts: s.vroToastTtsJoined ?? false,
        vroToastLeftTts: s.vroToastTtsLeft ?? false,
        vroToastReqInviteTts: s.vroToastTtsReqInvite ?? false,
